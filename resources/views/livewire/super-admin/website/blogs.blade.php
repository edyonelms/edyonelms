        ...
        <div class="px-4 sm:px-6 py-4">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <div class="flex items-center gap-2 flex-shrink-0">
                    <a href="{{ url('web/blogs') }}" target="_blank" rel="noopener"
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 py-6 space-y-5">
        ...
        <div class="flex flex-col sm:flex-row gap-3 sm:items-center">
            ...
            <select wire:model.live="dateFilter"
                class="sm:w-52 px-3 py-2.5 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 bg-white">
