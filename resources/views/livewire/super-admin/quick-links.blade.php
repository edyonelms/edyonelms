<div class="p-4 sm:p-6">
    <div class="rounded-lg">
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 overflow-y-auto ">
            ...
            {{-- Logout — opens the navbar's logout confirmation modal --}}
            <button type="button"
                wire:click="$dispatchTo('components.nav-bar', 'open-logout-confirm')"
                class="flex flex-col items-center p-3 rounded-lg border border-gray-200 hover:bg-gray-50 bg-white transition focus:outline-none">
                <div class="w-10 h-10 bg-red-100 rounded-full flex items-center justify-center mb-2">
                    <x-icon name="arrow-right-on-rectangle" class="w-5 h-5 text-red-600" />
                </div>
