    ...
    <div class="bg-white border-b border-gray-200 px-6 sticky top-0 z-40">
        <div class="flex items-center gap-3 pt-4">
            ...
            <div class="min-w-0">
                ...
                <p class="text-sm text-gray-500 mt-0.5 truncate">Manage your platform's terms and conditions</p>
            </div>
        </div>
        ...
        @else
            ...
            <div class="bg-white border-b border-gray-200 px-4 sm:px-6 py-4 sm:py-5">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div>
                        <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Terms And Condition</h1>
                        <p class="text-sm text-gray-500 mt-0.5">Please read these terms carefully before using our platform.</p>
                    </div>
