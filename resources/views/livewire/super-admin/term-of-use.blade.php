                ...
                <div class="max-w-5xl mx-auto px-6 py-10">
                    <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                        <div class="flex-shrink-0">
                            <div class="w-24 h-24 rounded-2xl bg-blue-100 flex items-center justify-center shadow-sm">
                                <img src="{{ asset('website-image/Group 11525.png') }}" alt="App Logo"
                                    class="w-24 h-24 rounded-2xl object-contain border border-gray-200 shadow-sm bg-white p-2">
                            </div>
                        </div>
                        <div class="text-center sm:text-left flex-1">
                            <h1 class="text-3xl font-bold text-gray-900">Terms And Condition</h1>
                            <p class="text-gray-500 mt-1 text-sm">Please read these terms carefully before using our
                                platform.</p>
                            @if ($termOfUse->last_updated)
                                <span
                                    class="inline-block mt-2 text-xs px-3 py-1 bg-blue-50 text-blue-600
                                             rounded-full border border-blue-100 font-medium">
