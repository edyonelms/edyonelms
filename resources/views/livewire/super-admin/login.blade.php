            ...
            <div class="w-full max-w-sm">
                ...
                <div class="mb-4" x-data="{ showPass: false }">
                    ...
                    <div class="relative">
                        ...
                        >
                        <button type="button" @click="showPass = !showPass" class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600 focus:outline-none">
                ...
                <div class="flex items-center justify-end mb-6">
                    <div>
                        <a href="{{ route('super-admin.forgot-password') }}" class="text-sm text-purple-600 hover:text-purple-800 hover:underline">Forgot password?</a>
                    </div>
                </div>
