    ...
    <div class="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div class="px-4 sm:px-6 py-4 sm:py-5">
            ...
            <div class="flex flex-wrap items-center gap-2 mt-3">
                ...
                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-gray-50 border border-gray-200 text-xs text-gray-500">Total <strong class="text-gray-900">{{ $totalStudents }}</strong></span>
                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-emerald-50 border border-emerald-100 text-xs text-emerald-600">Active <strong class="text-emerald-700">{{ $activeStudents }}</strong></span>
                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-red-50 border border-red-100 text-xs text-red-600">Inactive <strong class="text-red-700">{{ $inactiveStudents }}</strong></span>
            </div>
        </div>
