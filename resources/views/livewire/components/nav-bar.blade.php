        ...
        <div class="flex items-center justify-between h-16 gap-4">
            ...
            <div class="flex items-center gap-1.5 flex-shrink-0">
                ...
                @if (auth()->user()->role === 'admin')
                    <a href="{{ route('admin.admissions', ['organization' => auth()->user()->organization_id]) }}"
                       title="Admissions"
                       class="h-9 w-9 inline-flex items-center justify-center rounded-full bg-white border border-gray-300 hover:bg-gray-50 text-gray-600 hover:text-blue-600 transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v8m-4-4h8m5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                    </a>
                @endif
