<div class="p-4">
    ...
    @if ($viewMode === 'list')
        ...
        {{-- Header --}}
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 p-6 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl shadow-sm border mb-6">
            <div>
            ...
            <button wire:click="openIssueScreen"
                class="px-5 py-2.5 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white rounded-lg font-medium shadow-md hover:shadow-lg transition-all duration-200 flex items-center gap-2">
            ...
            <div class="bg-white rounded-xl shadow-sm border p-5">
                <div class="flex items-center gap-4">
                    <div class="flex-shrink-0 w-12 h-12 bg-emerald-100 rounded-lg flex items-center justify-center">
                        <x-icon name="users" class="h-6 w-6 text-emerald-600" />
                    </div>
                    <div>
                ...
                <div class="lg:col-span-2">
                    <div class="relative">
                        ...
                        <input type="text" wire:model.live.debounce.300ms="search"
                            ...
                            class="pl-10 pr-4 py-2.5 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm">
                    </div>
                </div>
                                    ...
                                    <div class="flex items-center justify-center gap-2">
                                        @if ($card->status === 'issued')
                                            ...
                                            <a href="{{ route('accounts.report-card.print', ['organization' => auth()->user()->organization_id, 'id' => $card->id]) }}"
                                                target="_blank"
                                                class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-teal-50 text-teal-600 hover:bg-teal-100 transition-colors"
                                                title="Print">
    ...
    @else
        ...
        <div class="flex items-center gap-4 p-6 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl shadow-sm border mb-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border mb-6 p-6">
            <h3 class="text-lg font-semibold text-gray-800 mb-4 flex items-center gap-2">
                <span class="w-7 h-7 bg-emerald-600 text-white rounded-full flex items-center justify-center text-sm font-bold">1</span>
                ...
                <div class="p-6 border-b border-gray-200">
                    <div class="flex justify-between items-center">
                        <h3 class="text-lg font-semibold text-gray-800 flex items-center gap-2">
                            <span class="w-7 h-7 bg-emerald-600 text-white rounded-full flex items-center justify-center text-sm font-bold">2</span>
                            Select Students
                        </h3>
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center gap-3">
                                            <div class="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0
                                                {{ $student['marks_complete'] ? 'bg-emerald-100' : 'bg-gray-200' }}">
                                                <span class="{{ $student['marks_complete'] ? 'text-emerald-700' : 'text-gray-500' }} font-semibold text-xs">
