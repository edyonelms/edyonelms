<div class="min-h-screen bg-gray-50">
    ...
    @if($showBulkScreen)
    <div class="fixed inset-0 z-[9998] bg-gray-50 overflow-y-auto">
        <div class="bg-white border-b border-gray-200 sticky top-0 z-10">
            <div class="px-4 sm:px-6 py-4 sm:py-5 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Bulk Generate Admit Cards</h1>
                        <p class="text-sm text-gray-500 mt-0.5">Auto-generate by attendance or fee eligibility</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 py-6 space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <label class="flex items-start gap-3 cursor-pointer rounded-lg border p-3 transition {{ $bulkGenerateType === 'fee' ? 'border-blue-500 bg-blue-50/50' : 'border-gray-200 hover:bg-gray-50' }}">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-400">Generate if paid fee % meets threshold</p>
                        </div>
                    </label>
                </div>
            ...
            <div class="flex justify-end gap-3 pb-8">
                <button wire:click="closeBulkScreen" class="px-5 py-2.5 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition">Cancel</button>
                <button wire:click="bulkGenerateAdmitCards" wire:loading.attr="disabled" class="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold shadow-sm transition">
